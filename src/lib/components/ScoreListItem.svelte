...
<a
	...
	class="group/item flex h-14 w-full justify-between rounded p-2 transition hover:bg-zinc-700 hover:shadow-lg data-[claimer=BLUE]:bg-blue-600 data-[claimer=RED]:bg-amber-600 data-[pass=false]:opacity-60"
